...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            DialogResult cevap;
            cevap = fontDialog1.ShowDialog();
            if (cevap == DialogResult.OK) richTextBox1.SelectionFont = fontDialog1.Font;
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            DialogResult cevap;
            cevap = colorDialog1.ShowDialog();
            if (cevap == DialogResult.OK) richTextBox1.SelectionColor = colorDialog1.Color;
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            DialogResult cevap;
            cevap = colorDialog1.ShowDialog();
            if (cevap == DialogResult.OK) richTextBox1.SelectionBackColor = colorDialog1.Color;
        }
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            richTextBox1.SelectionFont =
                new Font(richTextBox1.SelectionFont.Name, Convert.ToSingle(comboBox2.Text), richTextBox1.SelectionFont.Style ^ FontStyle.Bold);
        }
